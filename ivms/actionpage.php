...
<head>
<meta http-equiv = "refresh" content = "15;url= front.php"/>
...
if(empty($_POST["cno"]) && strlen($_POST["cno"] != 15) )
...
if(empty($name) || empty($cno) || empty($p) || strlen($cno)!=15)
{
	echo "<br><br><h4>You have not entered the details correctly !!</h4>";
}
else{
$sql = "INSERT INTO info_visitor(Name, Contact, Purpose, day, month, year, Date, TimeIN, ReceiptID, Status, ids, veh) VALUES ('$name','$cno','$p','$day', '$month', '$year','$date','$timein','$rid','ONLINE','$ids','$veh')";
