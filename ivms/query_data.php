...
function echoDetails($row){
   ...
   echo '<div class="col-sm-2">
             <div class="thumbnail" style = "width:175px;">
	           <img src="'.$result['profile_photo'].'" alt="profile-photo" style="width:60px;height:60px"/>
		   ...
		   <p>Time Out : '.$result['TimeOUT'].'</p>
	           <p>Date    : '.$result['Date'].'</p>
	           <p>Meeting : '.$result['meetingTo'].'</p>
			   <p>Purpose : '.$result['Purpose'].'</p>
			   <p>National ID : '.$result['ids'].'</p>
			   <p>Vehical Details : '.$result['veh'].'</p>
	        </div>
	       </div>';
	   }
  }         
