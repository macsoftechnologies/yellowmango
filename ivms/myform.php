...
if($_SERVER["REQUEST_METHOD"] =="POST")
{
	...
	if(!empty($_POST['photo_url']))
	{
		...
		$imageName = "profile-".time().".".$imgExt;
		
		$decoded=base64_decode($image);
		file_put_contents("image/".$imageName,$decoded);
		$profile_photo = "image/".$imageName;
	}
  ...
  if(empty($_POST["purpose"]))
	...
	$sql = "INSERT INTO info_visitor(Name, Contact, Purpose, meetingTo, day, 
				 ...
				 Comment,registeredBy,profile_photo) VALUES ('$name','$cno','$p',
...
<input type="hidden" name="photo_url" id="photo_url">
 ...
 <input autocomplete="off" id="mydata" type="hidden" name="mydata">
    ...
    <div class="contentarea">
		...
		<p>
        <div><button id="startbutton" style= "float:center; padding-right:240px;padding-top:20px;">Take The photo</button></div>
		</p>
       <canvas id="canvas">
        <div class="output">
