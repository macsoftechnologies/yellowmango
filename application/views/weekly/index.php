     ...
     <div class="modal fade" id="productModal">
              <div class="modal-dialog">
                <div class="modal-content photo-modal" style="height: 285px;">
                  ...
                  <div class="modal-body">
                    <div class="add-photo">
                       <form action="<?=base_url()?>time/updateweekly/<?php echo $time['time_id'];?>" role="form" id="userForm2" name="userForm" method="post" enctype="multipart/form-data" class="image-modal-form">
                        <div class="col-md-12">
                          <div class="row">
                            <div class="col-md-12">
        ...
        <div class="row">
          <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Weekly Cities Details</h4>
                <!-- <p class="card-description"> Add class <code>.table</code>
                </p> -->

                <div class="pull-right">
                   <a href="<?=base_url()?>weeklycities/create" class="btn btn-success btn-xs"  data-toggle="tooltip" data-placement="left" title="Create User" style="margin-left: 850px; margin-top: -50px;"><i class="mdi mdi-plus"></i> Create</a>
                </div>
                <div class="content">
                    <div class="table-full-width">
                        <table class="table">
                            <th>S.no</th>
                            <th>Weekly City Name</th>
                            <th>Actions</th>
                            <tbody>
                                <?php if($weekly->num_rows() > 0) { 
                                    foreach ($weekly->result() as $key => $ww) { ?>
                                <tr>
                                    <td><span class="btn btn-success btn-xs"><?php echo $key+1;?></span></td>
                                    <td><?php echo $ww->weekly_city_name;?></td>
                                   
                                    <td class="td-actions">
                                        <a href="<?=base_url();?>weeklycities/edit/<?php echo $ww->weekly_city_id;?>" rel="tooltip" title="Edit Task" class="btn btn-success btn-simple btn-sm" style="padding: 5px;">
                                            <i class="mdi mdi-pencil"></i>
                                        </a>
                                        <a href="<?=base_url();?>weeklycities/delete/<?php echo $ww->weekly_city_id;?>" rel="tooltip" onclick="return deleteItem();" title="Remove" class="btn btn-primary btn-simple btn-sm" style="padding: 5px;">
