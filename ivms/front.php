   ...
   if($resultDetails) {?>
      ...
      <div class="col-sm-8" style = "padding-left:25px;padding-top:15px; font-size:16px;">
        ...
        <span id="col-1" name="main">Name :&nbsp;
          ...
          <img src="<?php echo $resultDetails['profile_photo'];?>" alt="profile" style="width:300px; height:200px;"> </span><br>
        ...
        <span id="col-1">Contact No :&nbsp;
          ...
          <span id="col-1">Receipt ID :&nbsp;
			...
			<span id="col-1">ID :&nbsp;
            <?php echo $resultDetails['ids'];?></span><br>
			<span id="col-1">Vehical no. :&nbsp;
            <?php echo $resultDetails['veh'];?></span><br>
...
<h3 style="margin-right:auto;padding-left:40px;">Waiting For Checkout :&nbsp;<?php echo $onlineVsitor;?></h3>
